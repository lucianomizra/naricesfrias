...
(function ($) {
    ...
    var MatchResult = /** @class */ (function () {
        ...
        MatchResult.teamsInResultOrder = function (match) {
            ...
            if (bBye && !aBye) {
            	...
            	// AJUSTE: si empata gana el primero
                if (match.a.score.get() > match.b.score.get() || match.a.score.get() == match.b.score.get()) {
                    return [match.a, match.b];
                }
    ...
    function winnerBubbles(match) {
        ...
        winner.append('<div class="bubble"><div class="fa fa-trophy"></div></div>');
        var loser = el.find('.team.lose');
        loser.append('<div class="bubble">2°</div>');
        return true;
    }
    function consolationBubbles(match) {
        var el = match.el;
        var winner = el.find('.team.win');
        winner.append('<div class="bubble third">3°</div>');
        // var loser = el.find('.team.lose');
        // loser.append('<div class="bubble fourth">4°</div>');
        return true;
    }
    var endOfBranch = function () { throw new EndOfBranchException(); };
    var winnerMatchSources = function (teams, m) { return function () { return [
        { source: function () { return new TeamBlock(endOfBranch, teams[m][0], Option.of(Order.first()), Option.of(m * 2), Score.empty()); } },
        { source: function () { return new TeamBlock(endOfBranch, teams[m][1], Option.of(Order.second()), Option.of(m * 2 + 1), Score.empty()); } }
    ]; }; };
